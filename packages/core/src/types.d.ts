...
export type DataSource = 'feishu' | 'gitlab' | 'figma' | 'linear' | 'posthog' | 'email' | 'aliyun_oss';
export type SourceType = 'document' | 'wiki' | 'message' | 'calendar' | 'repository' | 'merge_request' | 'issue' | 'pipeline' | 'design_file' | 'component' | 'project' | 'cycle' | 'dashboard' | 'insight' | 'feedback' | 'complaint';
